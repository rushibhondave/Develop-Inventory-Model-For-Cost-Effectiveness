...
import com.raven.chart.blankchart.NiceScale;
...
public class BlankPlotChart extends JComponent {
    ...
    private void renderSeries(Graphics2D g2) {
        if (blankPlotChatRender != null) {
            ...
            double locationX = insets.left + textWidth + spaceText;
            for (int i = 0; i < labelCount; i++) {
              //  blankPlotChatRender.renderSeries(,g2, getRectangle(i, height, space, locationX, insets.top), i);
            }
        }
    }
    ...
    void addLegend(String income, Color color) {
